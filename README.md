...
## **Objective**  
The objective of this task is to **install and configure Splunk on an Ubuntu machine**. It will have Splunk up and running to collect and analyze security logs.
